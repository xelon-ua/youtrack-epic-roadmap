...
describe('IssueNodeCard', () => {
  it('shows id, summary and state, and opens the issue on click', () => {
    ...
    render(<IssueNodeCard node={node} highlighted={false} scheme="semantic" theme="light" />);
  ...
  it('dims resolved issues and labels external ones', () => {
    render(
      <IssueNodeCard node={{ ...node, resolved: true, kind: 'external-dependent' }} highlighted={false} scheme="semantic" theme="light" />,
    );
  ...
  it('takes its fill from the dark palette in the dark theme', () => {
    render(<IssueNodeCard node={node} highlighted={false} scheme="semantic" theme="dark" />);
  ...
  it('uses the YouTrack state colour in the youtrack scheme', () => {
    render(<IssueNodeCard node={node} highlighted={false} scheme="youtrack" theme="light" />);
